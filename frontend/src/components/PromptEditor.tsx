    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-white/60">
            Review the generated prompts. Edit anything — dialogue, scenes,
            descriptions. Click <strong>Confirm &amp; Generate Video</strong>{" "}
            when ready.
          </p>
        </div>
        <button
      ...
      <div className="space-y-4">
        ...
        <p className="text-xs text-white/50">
          Each prompt is sent directly to the AI. Edit freely — outfit lines,
          dialogue, camera, anything.
        </p>
